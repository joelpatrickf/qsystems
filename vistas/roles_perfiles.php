...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2 class="m-0">Administrar Módulos y Perfiles1</h2>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<script>
    ...
    $(document).ready(function() {
        ...
        /* ========================================================================
            ...
            Llena el select con lo modulos que tiene el Perfil
        =========================================================================== */
    ...
    //********************************************************************
    //  AJUSTA LAS CABECERAS DEL DATATABLE, TIENE PROBLEMAS DESACTIVADO //
    //********************************************************************
    ...
    function seleccionarModulosPerfil(pin_idPerfil) {
        ...
        for (let i = 0; i < modulos_sistema.length; i++) {
            ...
            //console.log("comparando",modulos_sistema[i]["text"]+"----"+modulos_usuario[i]["modulo"]);

            if (parseInt(modulos_sistema[i]["id"]) == parseInt(modulos_usuario[i]["id"]) && parseInt(modulos_usuario[i]["sel"]) == 1) {
                //console.log(modulos_sistema[i]["id"]);
