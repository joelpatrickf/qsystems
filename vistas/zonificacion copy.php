                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group mb-2">
                                <label class="" for="selArea"><i class="fas fa-signature fs-6"></i>
                                    <span class="small">Areas de Producción</span><span class="text-danger">*</span>
                                </label>
                                <select class="form-control form-select modalCajas" aria-label=".form-select example" id="selArea" disabled>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group mb-2">
                                <label class="" for="selLinea"><i class="fas fa-file-signature fs-6"></i>
                                    <span class="small">Líneas de Producción</span><span class="text-danger">*</span>
                                </label>
                                <select class="form-control form-select modalCajas" aria-label=".form-select example" id="selLinea" disabled>
...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(respuesta){
            ...
            var options = '<option selected value="0">Seleccione Area</option>';
            for (let index = 0; index < respuesta.length;index++){
                options = options + '<option value='+respuesta[index]['area_p']+'>'+respuesta[index]['area_p']+'</option>';
            }
    ...
    $("#selArea").change(function() {
        selResultadoArea = document.getElementById("selArea");
        selResultadosArea = selResultadoArea.options[selResultadoArea.selectedIndex].text;
        ...
        $.ajax({
            ...
            success: function(respuesta){
                ...
                var options;
                for (let index = 0; index < respuesta.length;index++){
                    options = options + '<option value='+respuesta[index]['linea_p']+'>'+respuesta[index]['linea_p']+'</option>';
                }
                $("#selLinea").html(options);
    ...
    $("#btnSave").click(function() {
        selResultadoLinea = document.getElementById("selLinea");
        selResultadosLinea = selResultadoLinea.options[selResultadoLinea.selectedIndex].text;
        
        const msg = [];
        var area =  selResultadosArea;
        var linea =  selResultadosLinea;
        var puntos =  $("#iptPuntos").val();
        
        if (area == 0){msg.push(' Area');}
        if (linea == 0){msg.push('Linea');}
