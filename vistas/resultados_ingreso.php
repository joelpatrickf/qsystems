		...
		<div class="col-md-12 px-0">
			<div class="card px-1">
				<div class="card-header pb-0 mb-0" >
                    <div class="row">
                        <div class="col-6">
					       <h4> Ingreso de resultados LOCAL</h4>
                        </div>
...
$(document).ready(function(){
    ...
    $("#btnBuscarOrden").click(function() {
        ...
        $.ajax({ //----BUSCAR ORDEN TRABAJO
            ...
            success: function(respuesta){
                console.log("buscar Orden 1",respuesta);
    ...
    $("#btnSave").click(function() {
        ...
        // CAPTURA el contenido del select o input  
        ...
        }else if (((validarMin == 'NUMERO') && (validarMax == 'VACIO')) || ((validarMin == 'VACIO') && (validarMax == 'NUMERO'))) {
    ...
    function validarTexto(valor) {
        //console.log("valor a validar :"+valor.length);
        if (valor.length >0){
