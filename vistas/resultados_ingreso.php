                                ...
                                <div class="col-6 col-sm-6 " >
                                    ...
                                    <!-- <div class="col-12 mt-1"> -->
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="iptOrdenTrabajo"  placeholder="# Orden"style="max-width:120px;display:inline-block"/>
                                    ...
                                    <form>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="iptResultados" placeholder="Resultados">
                                            </div>
                                            <div class="form-group col-md-6">
...
$(document).ready(function(){
    ...
    $("#btnSave").click(function() {
        ...
        varResultados = parseFloat($("#iptResultados").val());
